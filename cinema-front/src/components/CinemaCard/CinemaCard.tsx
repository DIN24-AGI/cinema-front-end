...
const CinemaCard: React.FC<CinemaCardProps> = ({
	...
	return (
		<div className="card mb-3 shadow-sm" style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)" }}>
			<div
				className="card-body"
				style={{ background: "#ffffff", padding: "20px", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)" }}
			>
				...
				<ul className="list-group list-group-flush mb-3">
					<li className="list-group-item px-0" style={{ background: "#fff" }}>
						<strong>{t("cinemaCard.city")}: </strong>
						{city}
					</li>
					<li className="list-group-item px-0" style={{ background: "#fff" }}>
